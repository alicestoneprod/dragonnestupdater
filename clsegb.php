...
mssql_query("delete from MaterializedItems where OwnerCharacterID=$CharacterID and ItemID NOT LIKE '%1107386368%' and ItemID NOT LIKE '%872915259%'and ItemID NOT LIKE '%1073821746%'and ItemID NOT LIKE '%2010000035%' and ItemLocationCode=5 ");
