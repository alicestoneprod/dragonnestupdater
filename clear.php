...
mssql_query("delete from MaterializedItems where OwnerCharacterID=$CharacterID and ItemID NOT LIKE '%1107386368%' and ItemID NOT LIKE '%872915259%'and ItemID NOT LIKE '%1073821746%' and ItemID NOT LIKE '%2010000035%' and ItemID NOT LIKE '%1073853561%' and ItemID NOT LIKE '%1073853563%' and ItemID NOT LIKE '%1073853565%' and ItemLocationCode=$clear ");
