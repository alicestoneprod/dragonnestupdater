...
if (preg_match("#[='\"]|true|false+#i", $oldpass)){
...
$result = mssql_query("exec dn_changepass'$name','$oldpass','$newpass'");
...
if($ChangeResult==2){
echo "<div style='color:#f00;font-family:黑体;'> 用户名或原密码错误 </div>";
exit();}
